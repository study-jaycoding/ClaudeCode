...
export const resultsLabel = $("results-label");
export const resultsClose = $("results-close");
...
export const lightboxBody = $("lightbox-body");
export const lightboxClose = $("lightbox-close");
