...
import { getAtQueryInfo, getBackslashQueryInfo, stripAtQuery, stripBackslashQuery } from "./prompt.js";
    ...
    promptInput.addEventListener("keydown", (e) => {
        ...
        if (isTagPickerOpen()) {
            if (e.key === "ArrowDown") {
                ...
                e.preventDefault(); closeTagPicker(); stripBackslashQuery();
            } else if (e.key === "Escape") {
                e.stopPropagation(); closeTagPicker(); stripBackslashQuery();
            }
            return;
        }
